...
**Last reconciled 2026-09-01, during P5** (partial — see the status board),
under D17.
...
| **Tests** | **1,463 passing, 0 failing** — 2026-09-01, run twice, against a real PostgreSQL 16 (pgvector). offline 50 · server-core 203 · ui-core 160 · academics-svc 141 · identity-svc 20 · ops-svc 98 · platform-svc 26 · rms-svc 62 · sms-svc 67 · sync-svc 23 · pwa 605 · netlify 8. **Without `DATABASE_URL` the same command reports 1,042 and prints "NOTHING RAN" for four workspaces** — the difference is the DB-backed suites, and reading past that line is how a green tick has meant nothing here before |
